...
bat2_coex <- bat2_porc_entre_meiavida
...
bat3_coex <- bat3_porc_entre_meiavida
...
##########################################################
aic_mle_soma_individual_coex <- AIC(bat2_coex_gama_nulo_mle) + AIC(bat3_coex_gama_nulo_mle) #4462.986
...
############# CALCULO DO AIC INDIVIDUAL TOTAL ############
##########################################################
aic_mle_soma_geral_coex <- AIC(geral_coex_gama_nulo_mle) #7459.243
...
abline(h=coef(bat2_coex_gama_nulo_mle)[[1]],col="red")
#bat3_coex_gama_scale_dist_lin_mle
abline(h=coef(bat3_coex_gama_nulo_mle)[[1]],col="blue")
