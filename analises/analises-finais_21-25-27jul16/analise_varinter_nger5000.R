...
load("~/Documents/LABTROP_LET/R/dados_mestrado/dados_output/dados_output_25jul16/bat2_porc_entre_nger5000.RData")
load("~/Documents/LABTROP_LET/R/dados_mestrado/dados_output/dados_output_27jul16/bat3_porc_entre_nger5000.RData")
...
bat2_coex <- bat2_porc_entre
bat2_coex <- bat2_coex[which(is.nan(bat2_coex)==F)]
bat2_indice_dist <- bat2_indice_dist[which(is.nan(bat2_coex)==F)]
...
bat3_coex <- bat3_porc_entre
bat3_coex <- bat3_coex[which(is.nan(bat3_coex)==F)]
bat3_indice_dist <- bat3_indice_dist[which(is.nan(bat3_coex)==F)]
