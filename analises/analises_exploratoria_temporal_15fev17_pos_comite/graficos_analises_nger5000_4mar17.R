...
dp500_mais_ind_ciclos_nger2000 <- apply(pos_comite_dp500_mais_ind_mortes_cumulativas_temporal-4e7,1,function(x){which(abs(x)==min(abs(x)))})
dp500_mais_ind_ciclos_nger2000<-as.numeric(dp500_mais_ind_ciclos_nger2000)
dp500_mais_ind_media_nger2000 <- c()
dp500_mais_ind_ss_total_nger2000 <- c()
dp500_mais_ind_var_total_nger2000 <- c()
dp500_mais_ind_ss_inter_nger2000 <- c()
dp500_mais_ind_var_inter_nger2000 <- c()
dp500_mais_ind_riqueza_nger2000 <- c()
for(i in 1:1000){
  dp500_mais_ind_media_nger2000[i] <- pos_comite_dp500_mais_ind_media_temporal[i,dp500_mais_ind_ciclos_nger2000[i]]
  dp500_mais_ind_ss_total_nger2000[i] <- pos_comite_dp500_mais_ind_ss_total_temporal[i,dp500_mais_ind_ciclos_nger2000[i]]
  #dp500_mais_ind_var_total_nger2000[i] <- pos_comite_dp500_mais_ind_var_total_temporal[i,dp500_mais_ind_ciclos_nger2000[i]]
  dp500_mais_ind_ss_inter_nger2000[i] <- pos_comite_dp500_mais_ind_ss_inter_temporal[i,dp500_mais_ind_ciclos_nger2000[i]]
  #dp500_mais_ind_var_inter_nger2000[i] <- pos_comite_dp500_mais_ind_var_inter_temporal[i,dp500_mais_ind_ciclos_nger2000[i]]
  dp500_mais_ind_riqueza_nger2000[i] <- pos_comite_dp500_mais_ind_riqueza_temporal[i,dp500_mais_ind_ciclos_nger2000[i]]
}
