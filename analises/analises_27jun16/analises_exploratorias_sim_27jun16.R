...
require(sensitivity)
par(mar=c(5,6,4,2))
## obs: para todas, entender melhor a relacao do parametro S com os resultados
# Media
...
# Razao_Media_xi0 (faz sentido que nao tenha nenhuma correlacao?)
...
abline(h=0,lty=2)
title(xlab="Parâmetros",ylab="Correlação Parcial com \nExcesso de Curtose")
# Pearson (nao entendi os resultados)
