...
start=list(a=0.921,b=0.000035,c=90000,d=0,shape=mean(var_inter_excl)^2/var(var_inter_excl))
var_inter_logit_excl_mle_gama <- mle2(funcao_logit_mle_gama, start=start)
#var_inter_logit_excl_mle_gama_nm <- mle2(funcao_logit_mle_gama, start=start,method = "Nelder-Mead",control=list(maxit=10000))
...
#### plotando
par(bty="l")
plot(var_inter_excl~dist_excl,pch=20,col="gray",bty="l",xlim=c(0,3e5),las=1,ylab="Média do índice de estratégia de vida",xlab="Índice de distúrbio")

#abline(var_inter_nulo_excl,col="gray")
#abline(h=coef(var_inter_nulo_excl_mle_normal)[[1]],col="gray")
#abline(h=coef(var_inter_nulo_excl_mle_normal_nm)[[1]],col="gray")
abline(h=coef(var_inter_nulo_excl_mle_gama)[[1]],col="gray")
abline(h=var(var_inter_excl)/coef(var_inter_nulo_excl_mle_gama_nm)[[1]],col="gray")

abline(var_inter_linear_excl)
#curve(coef(var_inter_linear_excl_mle_normal)[[1]]*x+coef(var_inter_linear_excl_mle_normal)[[2]],add=T)
#curve(coef(var_inter_linear_excl_mle_normal_nm)[[1]]*x+coef(var_inter_linear_excl_mle_normal_nm)[[2]],add=T)
#curve((coef(var_inter_linear_excl_mle_gama)[[1]]*x+coef(var_inter_linear_excl_mle_gama)[[2]]),add=T)
#curve((coef(var_inter_linear_excl_mle_gama_nm)[[1]]*x+coef(var_inter_linear_excl_mle_gama_nm)[[2]]),add=T)

curve(((coef(var_inter_mm_excl)[[1]]*x)/(coef(var_inter_mm_excl)[[2]]+x)+coef(var_inter_mm_excl)[[3]]),add=T,col="blue")
#curve(((coef(var_inter_mm_excl_mle_normal)[[1]]*x)/(coef(var_inter_mm_excl_mle_normal)[[2]]+x)+coef(var_inter_mm_excl_mle_normal)[[3]]),add=T,col="blue")
#curve(((coef(var_inter_mm_excl_mle_normal_nm)[[1]]*x)/(coef(var_inter_mm_excl_mle_normal_nm)[[2]]+x)+coef(var_inter_mm_excl_mle_normal_nm)[[3]]),add=T,col="blue")
#curve(((coef(var_inter_mm_excl_mle_gama)[[1]]*x)/(coef(var_inter_mm_excl_mle_gama)[[2]]+x)+coef(var_inter_mm_excl_mle_gama)[[3]]),add=T,col="blue")
curve(((coef(var_inter_mm_excl_mle_gama_nm)[[1]]*x)/(coef(var_inter_mm_excl_mle_gama_nm)[[2]]+x)+coef(var_inter_mm_excl_mle_gama_nm)[[3]]),add=T,col="blue")

#curve((coef(var_inter_pot_excl)[[1]]*(x^coef(var_inter_pot_excl)[[2]])+coef(var_inter_pot_excl)[[3]]),add=T,col="red")
#curve((coef(var_inter_pot_excl_mle_normal)[[1]]*(x^coef(var_inter_pot_excl_mle_normal)[[2]])+coef(var_inter_pot_excl_mle_normal)[[3]]),add=T,col="red")
#curve((coef(var_inter_pot_excl_mle_normal_nm)[[1]]*(x^coef(var_inter_pot_excl_mle_normal_nm)[[2]])+coef(var_inter_pot_excl_mle_normal_nm)[[3]]),add=T,col="red")
#curve((coef(var_inter_pot_excl_mle_gama)[[1]]*(x^coef(var_inter_pot_excl_mle_gama)[[2]])+coef(var_inter_pot_excl_mle_gama)[[3]]),add=T,col="red")
curve((coef(var_inter_pot_excl_mle_gama_nm)[[1]]*(x^coef(var_inter_pot_excl_mle_gama_nm)[[2]])+coef(var_inter_pot_excl_mle_gama_nm)[[3]]),add=T,col="red")

#curve((coef(var_inter_logit_excl)[[1]]/(1+exp(-(coef(var_inter_logit_excl)[[2]]*(x-coef(var_inter_logit_excl)[[3]])))))+coef(var_inter_logit_excl)[[4]],add=T,col="green")
#curve((coef(var_inter_logit_excl_mle_normal)[[1]]/(1+exp(-(coef(var_inter_logit_excl_mle_normal)[[2]]*(x-coef(var_inter_logit_excl_mle_normal)[[3]])))))+coef(var_inter_logit_excl_mle_normal)[[4]],add=T,col="green")
#curve((coef(var_inter_logit_excl_mle_normal_nm)[[1]]/(1+exp(-(coef(var_inter_logit_excl_mle_normal_nm)[[2]]*(x-coef(var_inter_logit_excl_mle_normal_nm)[[3]])))))+coef(var_inter_logit_excl_mle_normal_nm)[[4]],add=T,col="green")
curve(((coef(var_inter_logit_excl_mle_gama)[[1]]/(1+exp(-(coef(var_inter_logit_excl_mle_gama)[[2]]*(x-coef(var_inter_logit_excl_mle_gama)[[3]])))))+coef(var_inter_logit_excl_mle_gama)[[4]]),add=T,col="green")
curve(((coef(var_inter_logit_excl_mle_gama_nm)[[1]]/(1+exp(-(coef(var_inter_logit_excl_mle_gama_nm)[[2]]*(x-coef(var_inter_logit_excl_mle_gama_nm)[[3]])))))+coef(var_inter_logit_excl_mle_gama_nm)[[4]]),add=T,col="green")

curve((coef(var_inter_exp_excl)[[1]]*x+coef(var_inter_exp_excl)[[2]]),add=T,col="yellow")
#curve((coef(var_inter_exp_excl_mle_normal)[[1]]*x+coef(var_inter_exp_excl_mle_normal)[[2]]),add=T,col="yellow")
#curve((coef(var_inter_exp_excl_mle_normal_nm)[[1]]*x+coef(var_inter_exp_excl_mle_normal_nm)[[2]]),add=T,col="yellow")
curve((coef(var_inter_exp_excl_mle_gama)[[1]]*x+coef(var_inter_exp_excl_mle_gama)[[2]]),add=T,col="yellow")
curve((coef(var_inter_exp_excl_mle_gama_nm)[[1]]*x+coef(var_inter_exp_excl_mle_gama_nm)[[2]]),add=T,col="yellow")

#curve((coef(var_inter_quadr_excl)[[1]]*(x^2)+coef(var_inter_quadr_excl)[[2]]*x+coef(var_inter_quadr_excl)[[3]]),add=T,col="yellow")
#curve((coef(var_inter_quadr_excl_mle_normal_nm)[[1]]*(x^2)+coef(var_inter_quadr_excl_mle_normal_nm)[[2]]*x+coef(var_inter_quadr_excl_mle_normal_nm)[[3]]),add=T,col="yellow")
...
#curve(((coef(var_inter_holling_excl_mle_normal_nm)[[1]]*(x^2))/(coef(var_inter_holling_excl_mle_normal_nm)[[2]]+(coef(var_inter_holling_excl_mle_normal_nm)[[3]]*x)+(x^2)))+coef(var_inter_holling_excl_mle_normal_nm)[[4]],add=T,col="black")
curve(((coef(var_inter_holling_excl_mle_gama_nm)[[1]]*(x^2))/(coef(var_inter_holling_excl_mle_gama_nm)[[2]]+(coef(var_inter_holling_excl_mle_gama_nm)[[3]]*x)+(x^2)))+coef(var_inter_holling_excl_mle_gama_nm)[[4]],add=T,col="pink")

#curve((coef(var_inter_ricker_excl)[[1]]*x*exp(coef(var_inter_ricker_excl)[[2]]*x)+coef(var_inter_ricker_excl)[[3]]),add=T,col="purple")
#curve((coef(var_inter_ricker_excl_mle_normal_nm)[[1]]*x*exp(coef(var_inter_ricker_excl_mle_normal_nm)[[2]]*x)+coef(var_inter_ricker_excl_mle_normal_nm)[[3]]),add=T,col="purple")
#curve((coef(var_inter_ricker_excl_mle_gama)[[1]]*x*exp(coef(var_inter_ricker_excl_mle_gama)[[2]]*x)+coef(var_inter_ricker_excl_mle_gama)[[3]]),add=T,col="purple")
curve((coef(var_inter_ricker_excl_mle_gama_nm)[[1]]*x*exp(coef(var_inter_ricker_excl_mle_gama_nm)[[2]]*x)+coef(var_inter_ricker_excl_mle_gama_nm)[[3]]),add=T,col="purple")
