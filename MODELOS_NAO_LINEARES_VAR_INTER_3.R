...
#### plotando
plot(var_inter_adapt_excl~dist_adapt_excl,pch=20,col="gray",bty="l",xlim=c(0,3e5),las=1,ylab="Variância interespecífica do índice de estratégia de vida", xlab="Índice de distúrbio")
...
curve((coef(var_inter_ricker_adapt_excl)[[1]]*x*exp(coef(var_inter_ricker_adapt_excl)[[2]]*x)+coef(var_inter_ricker_adapt_excl)[[3]]),add=T,col="black")
