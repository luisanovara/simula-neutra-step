...
start=list(a=0.921,b=0.000045,c=80000,d=-8.4246e-05,shape=mean(media_adapt_excl)^2/var(media_adapt_excl))
...
curve(((coef(media_logit_adapt_excl_mle_gama_nm)[[1]]/(1+exp(-(coef(media_logit_adapt_excl_mle_gama_nm)[[2]]*(x-coef(media_logit_adapt_excl_mle_gama_nm)[[3]])))))+coef(media_logit_adapt_excl_mle_gama_nm)[[4]]),add=T,col="black")
