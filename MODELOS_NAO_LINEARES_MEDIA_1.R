...
par(bty="l")
plot(media_adapt~dist_adapt,pch=20,col="gray",bty="l",xlim=c(0,3e5),ylim=c(0,1),las=1,ylab="Média do índice de estratégia de vida",xlab="Índice de distúrbio")
curve((coef(media_logit_adapt)[[1]]/(1+exp(-(coef(media_logit_adapt)[[2]]*(x-coef(media_logit_adapt)[[3]])))))+coef(media_logit_adapt)[[4]],add=T,col="green")
curve((coef(media_logit_adapt_mle_normal_nm)[[1]]/(1+exp(-(coef(media_logit_adapt_mle_normal_nm)[[2]]*(x-coef(media_logit_adapt_mle_normal_nm)[[3]])))))+coef(media_logit_adapt_mle_normal_nm)[[4]],add=T,col="green")
...
abline(h=coef(media_nulo_adapt_mle_normal)[[1]],col="gray")
abline(h=coef(media_nulo_adapt_mle_normal_nm)[[1]],col="gray")
#abline(h=coef(media_nulo_adapt_mle_gama)[[1]],col="gray")
abline(h=coef(media_nulo_adapt_mle_gama_nm)[[1]],col="gray")

abline(media_linear_adapt)
curve(coef(media_linear_adapt_mle_normal)[[1]]*x+coef(media_linear_adapt_mle_normal)[[2]],add=T)
curve(coef(media_linear_adapt_mle_normal_nm)[[1]]*x+coef(media_linear_adapt_mle_normal_nm)[[2]],add=T)
#curve((coef(media_linear_adapt_mle_gama)[[1]]*x+coef(media_linear_adapt_mle_gama)[[2]]),add=T)
curve((coef(media_linear_adapt_mle_gama_nm)[[1]]*x+coef(media_linear_adapt_mle_gama_nm)[[2]]),add=T)

curve(((coef(media_mm_adapt)[[1]]*x)/(coef(media_mm_adapt)[[2]]+x)+coef(media_mm_adapt)[[3]]),add=T,col="blue")
curve(((coef(media_mm_adapt_mle_normal)[[1]]*x)/(coef(media_mm_adapt_mle_normal)[[2]]+x)+coef(media_mm_adapt_mle_normal)[[3]]),add=T,col="blue")
curve(((coef(media_mm_adapt_mle_normal_nm)[[1]]*x)/(coef(media_mm_adapt_mle_normal_nm)[[2]]+x)+coef(media_mm_adapt_mle_normal_nm)[[3]]),add=T,col="blue")
#curve(((coef(media_mm_adapt_mle_gama)[[1]]*x)/(coef(media_mm_adapt_mle_gama)[[2]]+x)+coef(media_mm_adapt_mle_gama)[[3]]),add=T,col="blue")
curve(((coef(media_mm_adapt_mle_gama_nm)[[1]]*x)/(coef(media_mm_adapt_mle_gama_nm)[[2]]+x)+coef(media_mm_adapt_mle_gama_nm)[[3]]),add=T,col="blue")
...
curve((coef(media_pot_adapt_mle_normal_nm)[[1]]*(x^coef(media_pot_adapt_mle_normal_nm)[[2]])+coef(media_pot_adapt_mle_normal_nm)[[3]]),add=T,col="red")
#curve((coef(media_pot_adapt_mle_gama)[[1]]*(x^coef(media_pot_adapt_mle_gama)[[2]])+coef(media_pot_adapt_mle_gama)[[3]]),add=T,col="red")
curve((coef(media_pot_adapt_mle_gama_nm)[[1]]*(x^coef(media_pot_adapt_mle_gama_nm)[[2]])+coef(media_pot_adapt_mle_gama_nm)[[3]]),add=T,col="red")

curve((coef(media_logit_adapt)[[1]]/(1+exp(-(coef(media_logit_adapt)[[2]]*(x-coef(media_logit_adapt)[[3]])))))+coef(media_logit_adapt)[[4]],add=T,col="green")
curve((coef(media_logit_adapt_mle_normal)[[1]]/(1+exp(-(coef(media_logit_adapt_mle_normal)[[2]]*(x-coef(media_logit_adapt_mle_normal)[[3]])))))+coef(media_logit_adapt_mle_normal)[[4]],add=T,col="green")
curve((coef(media_logit_adapt_mle_normal_nm)[[1]]/(1+exp(-(coef(media_logit_adapt_mle_normal_nm)[[2]]*(x-coef(media_logit_adapt_mle_normal_nm)[[3]])))))+coef(media_logit_adapt_mle_normal_nm)[[4]],add=T,col="green")
#curve(((coef(media_logit_adapt_mle_gama)[[1]]/(1+exp(-(coef(media_logit_adapt_mle_gama)[[2]]*(x-coef(media_logit_adapt_mle_gama)[[3]])))))+coef(media_logit_adapt_mle_gama)[[4]]),add=T,col="green")
curve(((coef(media_logit_adapt_mle_gama_nm)[[1]]/(1+exp(-(coef(media_logit_adapt_mle_gama_nm)[[2]]*(x-coef(media_logit_adapt_mle_gama_nm)[[3]])))))+coef(media_logit_adapt_mle_gama_nm)[[4]]),add=T,col="green")

curve((coef(media_exp_adapt)[[1]]*x+coef(media_exp_adapt)[[2]]),add=T,col="yellow")
curve((coef(media_exp_adapt_mle_normal)[[1]]*x+coef(media_exp_adapt_mle_normal)[[2]]),add=T,col="yellow")
curve((coef(media_exp_adapt_mle_normal_nm)[[1]]*x+coef(media_exp_adapt_mle_normal_nm)[[2]]),add=T,col="yellow")
#curve((coef(media_exp_adapt_mle_gama)[[1]]*x+coef(media_exp_adapt_mle_gama)[[2]]),add=T,col="yellow")
curve((coef(media_exp_adapt_mle_gama_nm)[[1]]*x+coef(media_exp_adapt_mle_gama_nm)[[2]]),add=T,col="yellow")
